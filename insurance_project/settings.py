...
INSTALLED_APPS = [
    ...
    # Project apps (Phase 1 - Foundation)
    'apps.accounts',
    'apps.catalog',
    'apps.customers',
    
    # Project apps (Phase 2 - Core Business Logic)
    'apps.applications',
    'apps.quotes',
    'apps.policies',
    'apps.claims',
    
    # Project apps (Phase 3 - Partial)
    'apps.notifications',
    'apps.analytics',
...
TIME_ZONE = 'Asia/Kolkata'  # Indian timezone for this project
...
DEFAULT_FROM_EMAIL = config('DEFAULT_FROM_EMAIL', default='InsureHub <noreply@insurehub.com>')

# Fail silently in production to avoid breaking user flows
